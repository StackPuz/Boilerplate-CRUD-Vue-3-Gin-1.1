        ...
        <form method="post" @submit.prevent="create()">
          <div class="row">
            <div class="mb-3 col-md-6 col-lg-4">
              ...
              <select id="order_header_customer_id" name="CustomerId" class="form-select form-select-sm" v-model="orderHeader.CustomerId" required>
                <option v-for="customer in customers" :key="customer" :value="customer.Id" :selected="orderHeader.CustomerId == customer.Id">{{customer.Name}}</option>
              </select>
