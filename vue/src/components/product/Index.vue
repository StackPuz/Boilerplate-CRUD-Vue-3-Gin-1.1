          ...
          <table class="table table-sm table-striped table-hover">
            ...
            <tbody>
              <tr v-for="product in products" :key="product">
                ...
                <td class="d-none d-md-table-cell text-center"><a v-if="product.Image" :href="`http://localhost:8080/uploads/products/${product.Image}`" target="_blank" :title="`${product.Image}`"><img class="img-list" :src="`http://localhost:8080/uploads/products/${product.Image}`" /></a></td>
                <td>{{product.Name}}</td>
                ...
                <td class="text-center">
                  ...
                  <router-link class="btn btn-sm btn-danger" :to="`/product/delete/${product.Id}`" title="Delete"><i class="fa fa-times"></i></router-link>
                </td>
              </tr>
            </tbody>
          </table>
