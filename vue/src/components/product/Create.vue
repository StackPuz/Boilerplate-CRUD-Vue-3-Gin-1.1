        ...
        <form method="post" @submit.prevent="create()" enctype="multipart/form-data">
          <div class="row">
            ...
            <div class="mb-3 col-md-6 col-lg-4">
              ...
              <select id="product_brand_id" name="BrandId" class="form-select form-select-sm" v-model="product.BrandId" required>
                <option v-for="brand in brands" :key="brand" :value="brand.Id" :selected="product.BrandId == brand.Id">{{brand.Name}}</option>
              </select>
